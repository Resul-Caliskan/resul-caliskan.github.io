...
const SocialMedia = () => (
  <div className="social-media-container">
    ...
    <div className="logos">
      <SocialIcon 
        url="https://www.instagram.com/pexel_ui/" 
      ...
      />
      <SocialIcon 
        url="https://www.linkedin.com/in/vinod-jangid-b401111a1?original_referer=" 
        ariaLabel="My Linkdin"
        viewBox="0 0 448 512"
      ...
      />
      <SocialIcon 
        url="https://github.com/vinodjangid07" 
        ariaLabel="My github"
        viewBox="0 0 496 512"
      ...
      />
      <SocialIcon 
        url="mailto:infovinodjangid@gmail.com" 
        ariaLabel="My G mail"
        viewBox="0 0 512 512"
...
const SocialIcon = ({ url, ariaLabel, viewBox, path, id }) => (
  <a href={url} target="_blank" rel="noopener noreferrer" tabIndex="0" aria-label={ariaLabel}>
    <svg className="SocialHandle" viewBox={viewBox} id={id}>
      <path d={path} />
    </svg>
  </a>
);
...
const FooterAvatar = () => (
  <div className="footer-avatar-container">
    <img src="src/png/footer-avatar-vinod.png" alt="animation-head" className="footer-avatar-img" id="footer-wala-avatar" />
