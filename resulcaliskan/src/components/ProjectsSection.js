...
const ProjectsSection = () => {
  const projects = [
    ...
    {
      title: "Lunetra Studio",
      description: "Lunetra Studio: A fashion-forward site showcasing elegant collections with modern design, built to highlight quality, story, and craftsmanship.",
      favicon: "src/webp/lunetra-favicon.webp",
      image: "src/webp/lunetra-preview.webp",
      liveLink: "https://lunetra-studio.netlify.app/",
      githubLink: null,
      alt: "Lunetra website preview image"
    }
  ];
