 ...
 * SVG Icon Implementations matching steventey.com clean design.
 * Follows SRP, OCP, and avoids external type mismatches.
 */
export const SocialLinks: React.FC<SocialsProps> = ({ socials }) => {
